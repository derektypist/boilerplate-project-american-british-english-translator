...
suite('Unit Tests', () => {
  ...
  suite('Translate to American English', () => {
    ...
    test("Translate Prof Joyner at King's College, London.  to American English", (done) => {
      assert.equal(translator.toAmericanEnglish("Prof Joyner at King's College, London.")[0],"Prof. Joyner at King's College, London.");
      done();
    });
